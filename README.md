...
* in strings.xml app_name string to "Coinomi" and app_package to com.crownpay.wallet
* in build.gradle the package from "com.crownpay.wallet.dev" to "com.crownpay.wallet"
* in AndroidManifest.xml the android:icon to "ic_launcher" and all "com.crownpay.wallet.dev.*"  to "com.crownpay.wallet.*"
