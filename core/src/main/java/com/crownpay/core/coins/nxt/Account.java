...
//                + " existing key " + com.crownpay.core.coins.nxt.Convert.toHexString(account.getPublicKey()) + " new key " + com.crownpay.core.coins.nxt.Convert.toHexString(publicKey));
//    }
...
//        if (id != com.crownpay.core.coins.nxt.Crypto.rsDecode(com.crownpay.core.coins.nxt.Crypto.rsEncode(id))) {
...
//        name = com.crownpay.core.coins.nxt.Convert.emptyToNull(name.trim());
//        description = com.crownpay.core.coins.nxt.Convert.emptyToNull(description.trim());
...
//            data = com.crownpay.core.coins.nxt.Convert.compress(data);
//        }
//        return EncryptedData.encrypt(data, com.crownpay.core.coins.nxt.Crypto.getPrivateKey(senderSecretPhrase), getPublicKey());
//    }
//
...
//        }
//        byte[] decrypted = encryptedData.decrypt(com.crownpay.core.coins.nxt.Crypto.getPrivateKey(recipientSecretPhrase), getPublicKey());
//        if (uncompress && decrypted.length > 0) {
//            decrypted = com.crownpay.core.coins.nxt.Convert.uncompress(decrypted);
//        }
//        return decrypted;
//    }
//
